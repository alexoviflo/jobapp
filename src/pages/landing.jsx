  ...
  return (
    <main className="flex flex-col gap-10 sm:gap-20 py-10 sm:py-20">
      ...
      <div className='flex gap-6 justify-center'>
       <Link to='/jobs'>
       <Button variant='blue' size="xl">Finn En Jobb</Button>
       </Link>
      
       <Link to='/post-job'>
       <Button variant='destructive' size="xl">Send En Jobb</Button>
       </Link>
      ...
      <Card>
  <CardHeader>
    <CardTitle>Jobb Søkere</CardTitle>
  </CardHeader>
  <CardContent>
   Søk på en jobb.
  </CardContent>
...
<Card>
  <CardHeader>
    <CardTitle>For arbeidsgivere</CardTitle>
  </CardHeader>
  <CardContent>
    Legg ut jobber, finn beste kandidater.
  </CardContent>
